...
//      console.log("Found user:", m5, uid);
      if (withRankIcon) {
        return '<a class="bb-user" href="#{'+ uid +'}"><img class="bb-skin" src="http://bombermine.com/api/ctor/getskin?name=#{skin id={' + uid + '}}&thumb=1" /></a>';
      } else {
        return '@<a class="bb-user" href="#{'+ uid +'}">#{name id={' +uid +'}}</a>';
      }
